...
import com.fanziwen.utils.OverlayManager;
import com.fanziwen.utils.WalkingRouteOverlay;
...
public class RouteActivity extends BaseActivity implements OnGetRoutePlanResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBar("路线指引", R.drawable.nav_return, 0);
        dataBean = (HouseBean.DataBean) getIntent().getExtras().getSerializable("bean");
        loc_end = new LatLng(Double.parseDouble(dataBean.getLatitude()), Double.parseDouble(dataBean.getLongitude()));
...
//            设置定位图层的配置（定位模式，是否允许方向信息，用户自定义定位图标）
    ...
    public void onGetWalkingRouteResult(WalkingRouteResult result) {
        if (result == null || result.error != SearchResult.ERRORNO.NO_ERROR) {
            Toast.makeText(this, "抱歉，指引路线失败", Toast.LENGTH_SHORT).show();
        }
